    ...
    public function store(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'status' => ['required', Rule::in(['Active', 'Inactive', 'Graduated', 'Dropped', 'Suspended', 'Expelled'])],
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'status' => ['sometimes', 'required', Rule::in(['Active', 'Inactive', 'Graduated', 'Dropped', 'Suspended', 'Expelled'])],
